...
class TestSupplierinfoActiveIndex(TransactionCase):
    ...
    def test_new_record_defaults_to_active(self):
        ...
        self.assertTrue(self.si_tmpl.is_products_active)
        self.assertTrue(self.si_variant.is_products_active)
    ...
    def test_archive_template_deactivates_all_supplierinfo(self):
        ...
        self.assertFalse(self.si_tmpl.is_products_active)
        self.assertFalse(self.si_variant.is_products_active)
